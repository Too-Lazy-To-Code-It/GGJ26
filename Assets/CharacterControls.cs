...
public partial class @CharacterControls: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""PlayerMovement"",
            ""id"": ""0a8ec33d-43ce-4bda-8c2e-14778ea7fe95"",
            ""actions"": [
                {
                    ""name"": ""Movement"",
                    ""type"": ""PassThrough"",
                    ""id"": ""f643330e-c0f5-4ebf-beb6-dc8303f1d200"",
            ...
            ""bindings"": [
                {
                    ""name"": ""2D Vector"",
                    ""id"": ""81ebea77-4931-4630-b880-1b41196a9966"",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""3ff18354-003f-419e-a9b8-33c86c5ac133"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""6f56e935-a3be-4659-8bac-11de416a5ae9"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""58818525-7731-44f7-8518-1b3b64227bb1"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""9c83c1e7-79a9-4a98-95ef-f61f54e02cc8"",
    ...
    public interface IPlayerAbilitiesActions
    {
        ...
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnPlayerInputs(InputAction.CallbackContext context);
    }
}
